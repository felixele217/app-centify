...
<template>
    <div>
        ...
        <div class="flex h-screen flex-col lg:pl-72">
            <div
                class="flex items-center gap-x-4 self-stretch border-b border-gray-200 bg-white px-8 py-3 shadow-sm lg:gap-x-6"
            >
                <SearchBar />
            ...
            <main class="grow p-5 sm:px-10 lg:px-16 lg:py-10">
                <slot />
            </main>
        </div>
    </div>
